...
var _=require("lodash"),ajax=require("../json/ajax.cart"),EventBus=require("../events/events"),_Singleton=require("../tools/singleton"),Cart=function(){var t=this;t.ui=new(require("./cart.ui"))(t),t.order=new(require("./cart.order"))(t),t.tasks=new(require("./cart.tasks"))(t),t.quickCheckout=new(require("./cart.quickCheckout"))(t),t.init()};Cart.prototype.init=function(){var t=this,e={method:"init"};t.tasks.send(e)},Cart.prototype._get=function(){var t={};return t},Cart.prototype.add=function(t){var e=this;t=t||{},t.method="add_items",e.tasks.send(t)},Cart.prototype._add_items=function(t,e){return _.forIn(t.items,function(t,r){var o=_.toInteger(e[r])+_.toInteger(t);e[r]=o}),e},Cart.prototype.remove=function(t){var e=this;t=t||{},t.method="remove_items",e.tasks.send(t)},Cart.prototype._remove_items=function(t,e){return _.forIn(t.items,function(t,r){var o=_.toInteger(e[r])-_.toInteger(t);e[r]=o>0?o:0}),e},Cart.prototype.set=function(t){var e=this;t=t||{},t.method="set_items",e.tasks.send(t)},Cart.prototype._set_items=function(t,e){return _.forIn(t.items,function(t,r){e[r]=_.toInteger(t)}),e},Cart.prototype["delete"]=function(t){var e=this;t=t||{},t.method="delete_items",e.tasks.send(t)},Cart.prototype._delete_items=function(t,e){return _.chain(t.items).toArray().forEach(function(t){e[t]=0}).value(),e},Cart.prototype.clear=function(t){var e=this;t=t||{},t.method="clear_items",e.tasks.send(t)},Cart.prototype._clear_items=function(t,e){return _.forIn(e,function(t,r){e[r]=0}),e},Cart.prototype.add_checkout=function(t){var e=this;t=t||{},t.method="add_checkout",e.tasks.send(t)},Cart.prototype._add_checkout=function(t,e){return _.forIn(t.items,function(t,r){var o=_.toInteger(e[r])+_.toInteger(t);e[r]=o}),e},Cart.prototype.setCoupon=function(t){var e=this;t=t||{},t.method="set_coupon",e.tasks.send(t)},Cart.prototype._set_coupon=function(t,e){return e},Cart.prototype.getOrder=function(){var t=this;return t.order.get()},Cart.prototype._update=function(t,e){var r=this;r.tasks._before(),ajax.update(t,e).done(function(t){r.tasks._done(t)}).fail(function(t){r.tasks._fail(t)}).always(function(){r.tasks._always()})},Cart.prototype.setConfig=function(t){var e=this;e.ui.setConfig(t)},Cart.prototype.addItem=function(){},module.exports=_Singleton(Cart).getInstance();
...
var _=require("lodash"),CartOrder=function(r){var t=this;t._owner=r};CartOrder.prototype.set=function(r){var t=this;return t._patch(r),t},CartOrder.prototype.get=function(){var r=this;return r},CartOrder.prototype.getItems=function(){var r=this,t={};return _.forEach(r.order_lines,function(r){t[r.variant_id]=r.quantity}),t},CartOrder.prototype.getComments=function(){var r=this;return r.order_line_comments},CartOrder.prototype._patch=function(r){var t=this;t.order_lines=r.items,t.order_line_comments=r.order.order_line_comments,t.positions_count=t.order_lines.length,t.items_count=r.items_count,t.items_price=0,t.total_price=r.total_price,t.discounts=r.discounts,t._itemsPrice(),t._deliveryPrice(r),t._setId(),t._images()},CartOrder.prototype._itemsPrice=function(){var r=this;r.items_price=_.reduce(r.order_lines,function(r,t){return r+t.sale_price*t.quantity},0)},CartOrder.prototype._deliveryPrice=function(r){var t=this,e=_.toString(r.delivery_price)||_.toString(r.order.delivery_price);t.delivery_price=parseFloat(e)},CartOrder.prototype._setId=function(){var r=this;_.forEach(r.order_lines,function(r){r.id=r.variant_id})},CartOrder.prototype._images=function(){var r=this;_.forEach(r.order_lines,function(r){r.images=r.product.images})},CartOrder.prototype.getItemByID=function(r){var t,e=this;return r=_.toInteger(r),_.forEach(e.order_lines,function(e){if(e.id===r)return t=e,!1}),t},module.exports=CartOrder;

},{"lodash":2}],5:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),ajax=require("../json/ajax.checkout"),EventBus=require("../events/events"),CartQuickCheckout=function(o){var e=this;e._owner=o,e.selectors={disabled:"disabled",open:"data-quick-checkout",sendButton:".m-modal-button--checkout",closeButton:".m-modal-close",errors:".m-modal-errors",form:"#quick_checkout_form",modal:".m-modal--checkout",msgModal:"#insales-quick-checkout-msg"},e._init()};CartQuickCheckout.prototype._init=function(){var o=this;o._bindOpenModal(),$(function(){o.$modal=$(o.selectors.modal),o.$message=$(o.msgModal),o.$message.length||(o.$message=$('<div id="insales-quick-checkout-msg" class="m-modal m-modal--msg">\n<div class="m-modal-wrapper">\n<button class="button m-button m-modal-close" data-modal="close"></button>\n<div class="m-modal-msg center"></div>\n</div>\n</div>'),o.$message.appendTo($("body"))),o.$send=$(o.selectors.sendButton),o.$errors=$(o.selectors.errors),o.$overlay=$('<div class="m-overlay" />'),o.$form=$(o.selectors.form),o.$close=$(o.selectors.closeButton),o._bindCloseModal(),o._bindSend()}),o._bindEvents()},CartQuickCheckout.prototype.openModal=function(o){var e=this;o.css({position:"fixed",display:"block"}),$("body").append(e.$overlay)},CartQuickCheckout.prototype.closeModal=function(o){var e=this;o.removeAttr("style"),e.$overlay.remove(),e._targetForm._quickCheckout},CartQuickCheckout.prototype.send=function(){var o,e=this;e._targetForm._quickCheckout?(console.log("QuickCheckout: in process"),e._send()):(e._targetForm._quickCheckout=!0,o=e._owner.ui._parseProductForm(e._targetForm,e._targetButton),e._owner.add_checkout(o))},CartQuickCheckout.prototype._bindOpenModal=function(){var o=this;$(document).on("click","[data-quick-checkout]",function(e){e.preventDefault(),e.stopPropagation();var t=$(this);t.prop(o.selectors.disabled)?EventBus.publish("add_disabled:insales:quick_checkout",{button:t}):(o._targetForm=o._getProductForm(t),o._targetButton=t,o.openModal(o.$modal),o.$form.find("input:visible:first").focus())})},CartQuickCheckout.prototype._send=function(){var o=this,e={},t={action:{method:"send",modal:o.$modal,form:o.$form}};o.$form.find(":file").length&&window.FormData?(e.data=new FormData(o.$form.get(0)),e.processData=!1):e.data=o.$form.serialize(),o.$errors.html(""),EventBus.publish("before:insales:quick_checkout",t),ajax.quick(e).done(function(e){_.merge(t,e),o._success(t)}).fail(function(e){_.merge(t,e),o._errors(t)}).always(function(){EventBus.publish("always:insales:quick_checkout",t)})},CartQuickCheckout.prototype._success=function(o){var e=this;e._owner.clear(),e.showMessage(o.message),EventBus.publish("success:insales:quick_checkout",o)},CartQuickCheckout.prototype._errors=function(o){var e=this;_.forEach(o.errors,function(o){e.$errors.append($('<div class="m-modal-error">'+o+"</div>"))}),EventBus.publish("errors:insales:quick_checkout",o)},CartQuickCheckout.prototype._bindCloseModal=function(){function o(){event.preventDefault(),e._targetForm={},e._targetButton={},e.closeModal($(".m-modal")),e.$errors.html("")}var e=this;e.$close.off("click").on("click",function(e){o()}),$(document).on("click",".m-overlay",function(e){o()}).on("keyup",function(e){27==e.keyCode&&(e.preventDefault(),o())})},CartQuickCheckout.prototype._bindSend=function(){var o=this;o.$send.off("click").on("click",function(e){e.preventDefault(),o.send()}),o.$form.on("keypress",function(e){13==e.keyCode&&(e.preventDefault(),o.send())})},CartQuickCheckout.prototype._getProductForm=function(o){var e,t=this,s=o.attr(t.selectors.open)||!1,r=o.parents("form:first")||!1;return s&&$(s).is("form")?e=$(s):r&&$(r).is("form")?e=$(r):console.log("CartQuickCheckout: _getProductForm: target form: WAAAAT?!"),e},CartQuickCheckout.prototype._bindEvents=function(){var o=this;EventBus.subscribe("add_checkout:insales:cart",function(e){o._send()})},CartQuickCheckout.prototype.showMessage=function(o){var e=this;e.closeModal(e.$modal),e.openModal(e.$message),$(".m-modal-msg",e.$message).html(o)},CartQuickCheckout.prototype.hideMessage=function(){var o=this;o.closeModal(o.$message)},module.exports=CartQuickCheckout;

},{"../events/events":10,"../json/ajax.checkout":15,"jquery":1,"lodash":2}],6:[function(require,module,exports){
var _=require("lodash"),EventBus=require("../events/events"),CartTasks=function(t){var o=this;o._owner=t,o._lock=!1,o._taskToWork=[],o._taskInWork=[],o._init()};CartTasks.prototype._init=function(){var t=this,o=localStorage.getItem("cart");o=JSON.parse(o),o&&_.now()-o.addedAt<3e4&&t._owner.order.set(o)},CartTasks.prototype.send=function(t){var o=this;t?o._add(t):o._push()},CartTasks.prototype._add=function(t){var o=this;o._taskToWork.push(t),o._push()},CartTasks.prototype._push=function(){var t=this,o=t._taskToWork,s=t._owner.order.getItems(),r={comments:t._owner.order.getComments()};return!t._lock&&0!=o.length&&(t._lock=!0,t._taskInWork=t._taskToWork,t._taskToWork=[],_.forEach(t._taskInWork,function(o){s=t._task(o,s),_.assign(r.comments,o.comments),r.coupon=o.coupon},s),void t._send(s,r))},CartTasks.prototype._send=function(t,o){var s=this;s._owner._update(t,o)},CartTasks.prototype._task=function(t,o){var s=this,r="_"+t.method;return _.isFunction(s._owner[r])||(r="_get"),s._owner[r](t,o)},CartTasks.prototype._done=function(t){var o=this,s={};o._owner.order.set(t),t.addedAt=_.now(),localStorage.setItem("cart",JSON.stringify(t)),s=_.clone(o._owner.order.get()),_.forEach(o._taskInWork,function(t){s.action=t||{},EventBus.publish(t.method+":insales:cart",s)}),EventBus.publish("update_items:insales:cart",s)},CartTasks.prototype._fail=function(t){var o=this;0!=o._taskInWork.length&&_.concat(o._taskToWork,o._taskInWork)},CartTasks.prototype._always=function(){var t=this,o={};t._lock=!1,_.forEach(t._taskInWork,function(t){o.action=t||{},EventBus.publish("always:insales:cart",o)}),t._taskInWork=[],t.send()},CartTasks.prototype._before=function(){var t=this,o={};_.forEach(t._taskInWork,function(t){o.action=t||{},"init"!=t.method&&EventBus.publish("before:insales:cart",o)})},module.exports=CartTasks;

},{"../events/events":10,"lodash":2}],7:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),EventBus=require("../events/events"),CartDOM=function(t){var o=this;o.options={inProcess:"inProcess",disabled:"disabled",form:"data-cart-form",add:"data-item-add","delete":"data-item-delete",update:"data-cart-update",submit:"data-cart-submit",clear:"data-cart-clear",coupon:"data-coupon-submit",reloadOnCoupon:!0},o._owner=t,o._init()};CartDOM.prototype._init=function(){var t=this;t._bindAddItem(),t._bindDeleteItem(),t._bindUpdateCart(),t._bindClearOrder(),t._bindCoupon()},CartDOM.prototype.setConfig=function(t){var o=this;_.assign(o.options,t)},CartDOM.prototype._addItem=function(t){var o=this,e=t.parents("form:first");task=o._parseProductForm(e,t),o._owner.add(task)},CartDOM.prototype._bindAddItem=function(){var t=this;$(document).on("click","["+t.options.add+"]",function(o){o.preventDefault();var e=$(this);e.prop(t.options.inProcess)||(e.prop(t.options.disabled)?EventBus.publish("add_disabled:insales:product",{button:e}):(e.prop(t.options.inProcess,!0),t._addItem(e)))}),EventBus.subscribe("always:insales:cart",function(o){t._unlockButton(o,"add_items")})},CartDOM.prototype._quickCheckout=function(t){var o=this,e=t.parents("form:first");task=o._parseProductForm(e,t)},CartDOM.prototype._deleteItem=function(t){var o=this,e={items:[o._getId(t.attr(o.options["delete"]))],button:t};o._owner["delete"](e)},CartDOM.prototype._bindDeleteItem=function(){var t=this;$(document).on("click","["+t.options["delete"]+"]",function(o){o.preventDefault();var e=$(this);e.prop(t.options.inProcess)||(e.prop(t.options.inProcess,!0),t._deleteItem(e))}),EventBus.subscribe("always:insales:cart",function(o){t._unlockButton(o,"delete_items")})},CartDOM.prototype.updateOrder=function(t){var o=this,e=$("["+o.options.form+"]"),n=e.find('input[name*="cart[quantity]"]'),r={items:{},form:e,coupon:o._getCoupon(e)};t&&0!=t.length&&(r.button=t),r.items=o._getItems(n),o._owner.set(r)},CartDOM.prototype._bindUpdateCart=function(){var t=this,o="["+t.options.form+"]";$(document).on("keypress",o,function(o){"13"==o.keyCode&&(o.preventDefault(),t.updateOrder($(o.target)))}),$(document).on("click","["+t.options.update+"]",function(o){o.preventDefault();var e=$(this);e.prop(t.options.inProcess)||(e.prop(t.options.inProcess,!0),t.updateOrder(e))}),EventBus.subscribe("always:insales:cart",function(o){t._unlockButton(o,"set_items")}),$(function(){var e=$(o);e.length&&EventBus.subscribe("change_quantity:insales:item",function(o){o.action.product.closest(e).length&&t.updateOrder()})})},CartDOM.prototype.clearOder=function(t){var o=this,e=$("["+o.options.form+"]"),n=e.find('input[name*="cart[quantity]"]'),r={items:[],form:e};t&&0!=t.length&&(r.button=t),r.items=_.keys(o._getItems(n)),o._owner["delete"](r)},CartDOM.prototype._bindClearOrder=function(){var t=this;$(document).on("click","["+t.options.clear+"]",function(o){o.preventDefault();var e=$(this);e.prop(t.options.inProcess)||(e.prop(t.options.inProcess,!0),t.clearOder(e))}),EventBus.subscribe("always:insales:cart",function(o){t._unlockButton(o,"delete_items")})},CartDOM.prototype.setCoupon=function(t,o){var e=this,n={items:{},form:t,coupon:e._getCoupon(t),button:o};e._owner.setCoupon(n)},CartDOM.prototype._bindCoupon=function(){var t=this;$(document).on("click","["+t.options.coupon+"]",function(o){o.preventDefault();var e=$(this);t.setCoupon(e.parents("form:first"),e)}),$(document).on("keypress",'[name="cart[coupon]"]',function(o){13==o.keyCode&&(o.stopPropagation(),o.preventDefault(),t.setCoupon($(this).parents("form:first")))}),EventBus.subscribe("always:insales:cart",function(o){t._unlockButton(o,"set_coupon")}),EventBus.subscribe("set_coupon:insales:cart",function(o){o.action.form.is("["+t.options.form+"]")&&(t.options.reloadOnCoupon?document.location.reload():console.log('Вы отключили атвоматическое обновление страницы корзины после применения купона. Создайте свой обработчик по событию шины "set_coupon:insales:cart"'))})},CartDOM.prototype._getId=function(t){return _.toInteger(t.replace(/\D+/g,""))},CartDOM.prototype._getItems=function(t){var o=this,e={};return t.each(function(t,n){var r=$(n);e[o._getId(r.attr("name"))]=parseFloat(r.val())}),e},CartDOM.prototype._getCoupon=function(t){return t.find('[name="cart[coupon]"]').val()||!1},CartDOM.prototype._unlockButton=function(t,o){var e=this;t.action&&t.action.button&&t.action.method==o&&t.action.button.prop(e.options.inProcess,!1)},CartDOM.prototype._getComments=function(t){var o=this,e={},n=t.find('[name*="cart[order_line_comments]"]');return n.each(function(){var t=$(this);e[o._getId(t.attr("name"))]=t.val()}),e},CartDOM.prototype._parseProductForm=function(t,o){var e=this,n=t.find('[name*="variant_ids"]'),r=t.find('[name="variant_id"]'),a=t.find('input[name="quantity"]'),i=t.find('[name="comment"]'),s={items:{},comments:{},button:o,form:t,coupon:e._getCoupon(t),isQuickCheckout:o.checkoutButton||!1};return 1==r.length&&(s.items[_.toInteger(r.val())]=parseFloat(a.val()),s.comments[_.toInteger(r.val())]=i.val()),_.assign(s.items,e._getItems(n)),_.assign(s.comments,e._getComments(t)),s},module.exports=CartDOM;

},{"../events/events":10,"jquery":1,"lodash":2}],8:[function(require,module,exports){
var _=require("lodash"),ajax=require("../json/ajax.compare"),EventBus=require("../events/events"),_Singleton=require("../tools/singleton"),Compare=function(e){e=e||{};var t=this;t.products=[],t.maxItems=e.maxItems||4,t.ui=new(require("./compare.ui"))(t),t._update()};Compare.prototype.add=function(e){var t=this;return e.item=parseInt(e.item),e.method="add_item",t.products.length>=t.maxItems?(e.method="overload",t._events(e),void t._always(e)):_.findIndex(t.products,e.item)!=-1?(e.method="in_list",t._events(e),void t._always(e)):(t._before(e),void ajax.add(e.item).done(function(o){t._update(e)}).fail(function(o){console.log("fail: ",o),t._always(e)}))},Compare.prototype.remove=function(e){var t=this;e.item=parseInt(e.item),e.method="remove_item",t._before(e),ajax.remove(e.item).done(function(o){t._update(e)}).fail(function(o){console.log("fail: ",o),t._always(e)})},Compare.prototype.update=function(){var e=this;e._update({method:"update_items"})},Compare.prototype.getCompare=function(){var e=this;return e},Compare.prototype._update=function(e){var t=this;e=e||{},e.method=e.method||"init","init"!=e.method&&"update_items"!=e.method||t._before(e),ajax.get().done(function(o){t.products=o.products,t._events(e)}).fail(function(e){console.log("fail: ",e)}).always(function(){t._always(e)})},Compare.prototype._events=function(e){var t=this,o=t;o.action=e,EventBus.publish(e.method+":insales:compares",o),"update_items"!=o.action.method&&"overload"!=o.action.method&&EventBus.publish("update_items:insales:compares",o)},Compare.prototype._before=function(e){EventBus.publish("before:insales:compares",e)},Compare.prototype._always=function(e){EventBus.publish("always:insales:compares",e)},module.exports=_Singleton(Compare).getInstance();

},{"../events/events":10,"../json/ajax.compare":17,"../tools/singleton":52,"./compare.ui":9,"lodash":2}],9:[function(require,module,exports){
var $=require("jquery"),EventBus=require("../events/events"),CompareDOM=function(e){var t=this;t._owner=e,t._init()};CompareDOM.prototype._init=function(){var e=this;e.options={add:"data-compare-add","delete":"data-compare-delete",disabled:"disabled",inProcess:"inProcess"},e._bindAddItem(),e._bindDelteItem()},CompareDOM.prototype._bindAddItem=function(){var e=this;$(document).on("click","["+e.options.add+"]",function(t){t.preventDefault();var o=$(this);o.prop(e.options.inProcess)||(o.prop(e.options.inProcess,!0),e._addItem(o))}),EventBus.subscribe("always:insales:compares",function(t){var o="add_item"==t.method||"overload"==t.method;t.button&&o&&t.button.prop(e.options.inProcess,!1)})},CompareDOM.prototype._addItem=function(e){var t=this,o={button:e,item:parseInt(e.attr(t.options.add))};t._owner.add(o)},CompareDOM.prototype._bindDelteItem=function(){var e=this;$(document).on("click","["+e.options["delete"]+"]",function(t){t.preventDefault();var o=$(this);o.prop(e.options.inProcess)||(o.prop(e.options.inProcess,!0),e._deleteItem(o))}),EventBus.subscribe("always:insales:compares",function(t){t.button&&"remove_item"==t.method&&t.button.prop(e.options.inProcess,!1)})},CompareDOM.prototype._deleteItem=function(e){var t=this,o={button:e,item:parseInt(e.attr(t.options["delete"]))};t._owner.remove(o)},module.exports=CompareDOM;

},{"../events/events":10,"jquery":1}],10:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),_Singleton=require("../tools/singleton"),EventBus=function(){var e=this;return window.EventBus?window.EventBus:(e.eventsList={},e.logger=new(require("./events.logger"))(e),void(window.EventBus=e))};EventBus.prototype.publish=function(e,t){var n=this;return n.logger.addListner(e),n._selectEvent(e).fire(t)},EventBus.prototype.subscribe=function(e,t){var n=this;return n._selectEvent(e).add(t)},EventBus.prototype.unsubscribe=function(e,t){var n=this;return n._selectEvent(e).remove(t)},EventBus.prototype._selectEvent=function(e){var t,n=this;return e=_.toString(e),t=n.eventsList[e],t||(t=$.Callbacks("memory"),n.eventsList[e]=t),t},module.exports=_Singleton(EventBus).getInstance();

},{"../tools/singleton":52,"./events.logger":11,"jquery":1,"lodash":2}],11:[function(require,module,exports){
var _=require("lodash"),EventsLogger=function(t){var e=this;e._owner=t,e.loggersList={}};EventsLogger.prototype.add=function(t){var e=this;e.loggersList[t]={},e._init(t)},EventsLogger.prototype._init=function(t){var e=this;_.forEach(e._owner.eventsList,function(t,o){e.addListner(o)})},EventsLogger.prototype.addListner=function(t){var e=this,o=e._component(t);e._inList(o)&&!e._isListen(t)&&(e.loggersList[o][t]=!0,e._owner.subscribe(t,function(e){console.log("LISTNER: ",t,_.cloneDeep(e))}))},EventsLogger.prototype._inList=function(t){var e=this;return!!_.has(e.loggersList,t)},EventsLogger.prototype._isListen=function(t){var e=this,o=e._component(t),n=!1;return e._inList(o)&&(n=_.has(e.loggersList[o],t)),n},EventsLogger.prototype._component=function(t){return _.last(t.split(":"))},module.exports=EventsLogger;

},{"lodash":2}],12:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(o,r){var e=URL.getKeyValue("lang")||"",n={lang:e};return r=r||{},_.forIn(o,function(o,r){n["variant_ids["+r+"]"]=_.toInteger(o)}),_.forIn(r.comments,function(o,r){n["cart[order_line_comments]["+r+"]"]=o}),r.coupon&&(n["cart[coupon]"]=r.coupon),$.post("/cart_items.json",n)};

},{"../tools/url":54,"jquery":1,"lodash":2}],13:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r=URL.getKeyValue("lang")||"",o={lang:r,"product[id]":_.toInteger(e)};return $.post("/compares.json",o)};

},{"../tools/url":54,"jquery":1,"lodash":2}],14:[function(require,module,exports){
module.exports={add:require("./addCartItems"),update:require("./updateCartItems"),get:require("./getCartItems"),remove:require("./removeCartItem")};

},{"./addCartItems":12,"./getCartItems":21,"./removeCartItem":29,"./updateCartItems":32}],15:[function(require,module,exports){
module.exports={order:require("./makeOrder"),quick:require("./makeQuickCheckout")};

},{"./makeOrder":27,"./makeQuickCheckout":28}],16:[function(require,module,exports){
module.exports={get:require("./getCollection")};

},{"./getCollection":23}],17:[function(require,module,exports){
module.exports={get:require("./getCompareItems"),add:require("./addCompareItem"),remove:require("./removeCompareItem")};

},{"./addCompareItem":13,"./getCompareItems":24,"./removeCompareItem":30}],18:[function(require,module,exports){
module.exports={cart:require("./ajax.cart"),compare:require("./ajax.compare"),propduct:require("./ajax.product"),checkout:require("./ajax.checkout"),collection:require("./ajax.collection"),shop:require("./ajax.shop")};
...
module.exports={get:require("./getProduct"),getList:require("./getProductsList")};

},{"./getProduct":25,"./getProductsList":26}],20:[function(require,module,exports){
module.exports={message:require("./sendMessage"),client:require("./getClientInfo")};

},{"./getClientInfo":22,"./sendMessage":31}],21:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery");module.exports=function(){var e=$.Deferred(),r=$.cookie("cart"),o=URL.getKeyValue("lang")||"",n={lang:o};return r&&"json"!=r?(order=$.parseJSON(r)||null,e.resolve(order)):$.getJSON("/cart_items.json",n).done(function(r){e.resolve(r)}).fail(function(r){e.reject(r)}),e.promise()};

},{"../tools/url":54,"jquery":1}],22:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(){var e=URL.getKeyValue("lang")||"",r={lang:e},o=$.Deferred();return $.getJSON("/client_account/contacts.json",r).done(function(e){switch(e.status){case"error":o.resolve({message:e.message,url:e.url,authorized:!1});break;default:o.resolve(_.merge(e.client,{authorized:!0}))}}).fail(function(e){console.log("json.getClientInfo: fail: ",e),o.reject(e)}),o.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],23:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");getCollection=function(){var e="/collection/"+_.toString(arguments[0])+".json",r=URL.getKeyValue("lang")||"",o={lang:r},n=$.Deferred();return _.chain(arguments).drop().compact().forEach(function(e){_.assign(o,e)}).value(),$.getJSON(e,o).done(function(e){_.forEach(e.products,function(e){e&&r&&(e.url+="?lang="+r)}),n.resolve(e)}).fail(function(e){n.reject(e)}),n.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],24:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery");module.exports=function(e){var r=URL.getKeyValue("lang")||"",o={lang:r},n=$.Deferred();return $.getJSON("/compares.json",o).done(function(e){n.resolve(e)}).fail(function(e){n.reject(e)}),n.promise()};

},{"../tools/url":54,"jquery":1}],25:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r=URL.getKeyValue("lang")||"",o={lang:r,format:"json"},u=$.Deferred();return $.getJSON("/product_by_id/"+_.toInteger(e)+".json",o).done(function(e){e.product&&r&&(e.product.url+="?lang="+r),u.resolve(e.product)}).fail(function(e){console.log("JSON: ошибка при получении данных от платформы",e),u.resolve({})}),u.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],26:[function(require,module,exports){
var URL=require("../tools/url/"),$=require("jquery"),_=require("lodash");module.exports=function(n){var r=URL.getKeyValue("lang")||"",t={lang:r,format:"json"},u=25,e=_.chain(n).toArray().compact().chunk(u).map(function(n){return"/products_by_id/"+n.join()+".json"}).value(),o=$.map(e,function(n){return $.getJSON(n,t).then(function(n){return n})});return $.when.apply(this,o).then(function(){return _.chain(arguments).toArray().map(function(n){return n.products}).flatten().union().forEach(function(n){n&&r&&(n.url+="?lang="+r)}).value()})};

},{"../tools/url/":54,"jquery":1,"lodash":2}],27:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e,r){var t,o=$.Deferred(),n=URL.getKeyValue("lang")||"",i={lang:n,pid:1,"order[delivery_variant_id]":_.toInteger(r.delivery),"order[payment_gateway_id]":_.toInteger(r.payment)};return _.forIn(e,function(e,r){i["client["+r+"]"]=e}),$.post("/fast_checkout.json",i).done(function(e){"ok"==e.status?(t=$("<iframe src='/orders/successful' width='0' height='0'></iframe>"),$("body").append(t),t.on("load",function(){return $(t).remove()}),o.resolve(e)):o.reject(e)}).fail(function(e){o.reject(e)}),o.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],28:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r,o=$.Deferred(),t=URL.getKeyValue("lang")||"";return e.lang=t,e.pid=1,e.dataType="json",e.type="POST",$.ajax("/orders/create_with_quick_checkout.json",e).done(function(e){"ok"==e.result?(r=$("<iframe src='/orders/successful' width='0' height='0'></iframe>"),$("body").append(r),r.on("load",function(){return $(r).remove()}),o.resolve(e)):o.reject(e)}).fail(function(e){o.reject(e)}),o.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],29:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r="/cart_items/"+_.toInteger(e)+".json",t=URL.getKeyValue("lang")||"",o={lang:t,_method:"delete"};return $.post(r,o)};

},{"../tools/url":54,"jquery":1,"lodash":2}],30:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r=URL.getKeyValue("lang")||"",o={lang:r,_method:"delete"},t="/compares/"+_.toInteger(e)+".json";return $.post(t,o)};

},{"../tools/url":54,"jquery":1,"lodash":2}],31:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(e){var r=$.Deferred(),o=URL.getKeyValue("lang")||"",n={lang:o};return _.forIn(e,function(e,r){n["feedback["+r+"]"]=e}),$.post("/client_account/feedback.json",n).done(function(e){n&&"ok"==e.status?r.resolve(e):(e.message=n,r.reject(e))}),r.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],32:[function(require,module,exports){
var URL=require("../tools/url"),$=require("jquery"),_=require("lodash");module.exports=function(o,r){var e=URL.getKeyValue("lang")||"",n={lang:e,_method:"put"},t=$.Deferred();return r=r||{},_.forIn(o,function(o,r){n["cart[quantity]["+r+"]"]=_.toInteger(o)}),_.forIn(r.comments,function(o,r){n["cart[order_line_comments]["+r+"]"]=o}),r.coupon&&(n["cart[coupon]"]=r.coupon),$.post("/cart_items.json",n).done(function(o){_.forEach(o.items,function(o){o&&e&&(o.product_url+="?lang="+e,o.product.url+="?lang="+e)}),t.resolve(o)}).fail(function(o){t.reject(o)}),t.promise()};

},{"../tools/url":54,"jquery":1,"lodash":2}],33:[function(require,module,exports){
console.warn("Внимание подключена новая версия JS API InSales"),window.$=window.jQuery=require("jquery"),window._=require("lodash"),window.ajaxAPI=require("./json/ajax"),window.Template=require("./template/template"),window.EventBus=require("./events/events"),window.Shop=require("./shop/shop"),window.Cart=require("./cart/cart"),window.Compare=require("./compare/compare"),window.Products=require("./products/products"),window.AjaxSearch=require("./search/search"),window.Site={};
...
var $=require("jquery"),_=require("lodash"),Error=require("../tools/error"),EventBus=require("../events/events"),OptionSelector=function(t){var e=this;e._owner=t,e.selectors=e._owner.selectors,e.$product=t.$product,e._init()};OptionSelector.prototype._init=function(){var t=this;t._owner;if(0!=t.$product.length&&(t.$nativeSelect=t.$product.find("["+t.selectors.nativeSelect+"]"),0!=t.$nativeSelect.length)){var e=t.$product.find("["+t.selectors.optionSelector+"]");e.length||t.$nativeSelect.after('<div class="option-selector" '+t.selectors.optionSelector+"/>"),t.$optionSelector=t.$product.find("["+t.selectors.optionSelector+"]"),t.$nativeSelect.hide(),t._bindEvents(),t._renderSelector()}},OptionSelector.prototype._renderSelector=function(){var t=this,e=t._owner.variants,o=t._owner.product._images,n=t._owner.product.settings;if(n.showVariants&&t.$optionSelector){var r=_.reduce(e.options,function(r,i,c){return r+=t._renderOption({option:e.getFilterOption(c),images:o,fileUrl:n.fileUrl,initOption:n.initOption})},"");t.$optionSelector.html(r)}},OptionSelector.prototype._renderOption=function(t){var e=t.option.renderType;if(!e)throw new Error("ErrorOptionSelector","ошибка в получении шаблона");return Template.render(t,e)},OptionSelector.prototype._bindEvents=function(){var t=this;return!document._optionSelectors&&(document._optionSelectors=!0,t._bindSetVariant(),t._bindOptionTriggers(),t._bindEvents(),void t._bindUpdateVariant())},OptionSelector.prototype._bindUpdateVariant=function(){var t=this;EventBus.subscribe("update_variant:insales:product",function(e){if("update"==e.action.method){var o,n=t._owner.getInstance(e.action.product);if(!n)return!1;o=n.optionSelector,o&&(o.$nativeSelect.val(e.id),o._renderSelector())}})},OptionSelector.prototype._bindSetVariant=function(){var t=this;$(document).on("change","["+t.selectors.nativeSelect+"]",function(e){e.preventDefault();var o=$(this),n=_.toInteger(o.val()),r=(o.parents("[data-product-id]:first")[0],t._owner.getInstance(o));return!!r&&void r.variants.setVariant(n)})},OptionSelector.prototype._bindOptionTriggers=function(){var t=this;$(document).on("change click","[data-option-bind]",function(e){e.preventDefault();var o,n=$(this),r=t._owner.getInstance(n);return(!n.is("select")||"click"!==e.type)&&(!!r&&(o={option_name_id:n.data("option-bind"),position:n.data("value-position")},n.is("select")&&(o.position=_.toInteger(n.val())),void r.variants.setOption(o)))})},module.exports=OptionSelector;

},{"../events/events":10,"../tools/error":50,"jquery":1,"lodash":2}],35:[function(require,module,exports){
var _=require("lodash"),ProductPriceType=function(i){var r=this;return r._owner=i,r.price_kinds={},r._init(),r};ProductPriceType.prototype._init=function(){var i=this;i.price_kinds=i._initPrices(i._owner.product)},ProductPriceType.prototype._initPrices=function(i){var r=i.price_kinds,t={};return _.forEach(i.variants,function(e){t[e.id]=[],t[e.id].push({min_quantity:0,price:parseFloat(e.price)}),i.price_kinds.length&&_.forEach(e.prices,function(i,n){t[e.id].push({min_quantity:r[n].value,price:parseFloat(e.prices[n])})})}),t},ProductPriceType.prototype.getPrice=function(i){var r=this,t=0;return _.forEach(r.price_kinds[i.variantId],function(r){return!(i.quantity<r.min_quantity)&&void(t=r.price)}),t},module.exports=ProductPriceType;

},{"lodash":2}],36:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),Error=require("../tools/error"),_Settings=require("./settings"),_Instance=require("./productInstance"),Product=function(r,t){var e=this;if(!r)throw new Error("ErrorProduct","ошибка в передаче продукта");e._selectors={product:"data-product-id"},_.merge(e,r),e.settings=new _Settings(t,e),e._images=e._getImage(r.images),e._init()};Product.prototype._init=function(){var r=this;r._instance=r._initInstance()},Product.prototype._getImage=function(r){var t={};return _.size(r)>0&&_.forEach(r,function(r){if(r.title){var e=r.title.toLowerCase();t[e]={thumb_url:r.thumb_url,small_url:r.small_url,medium_url:r.medium_url,large_url:r.large_url,original_url:r.original_url}}}),t},Product.prototype._initInstance=function(){var r=this;r.$product=$("["+r._selectors.product+'="'+r.id+'"]'),r.$product.each(function(){new _Instance(r,$(this))})},module.exports=Product;

},{"../tools/error":50,"./productInstance":37,"./settings":39,"jquery":1,"lodash":2}],37:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),EventBus=require("../events/events"),ProductInstance=function(t,e){var n=this;n.selectors={product:"data-product-id",item:"data-item-id",nativeSelect:"data-product-variants",optionSelector:"data-option-selector",quantity:"data-quantity",quantityButton:"data-quantity-change"},n._owner=t,n.settings=n._owner.settings,n.product=n._owner,n.quantity={},n.type="product",n.$product=e,e[0].Product=n,n._init()};ProductInstance.prototype._init=function(){var t=this;t.variants=new(require("./tree"))(t),t._initQuantity(),t.price_kinds=new(require("./priceTypes"))(t),t.$product.data("item-id")&&(t.type="item"),t._initOptionSelectors(),t._bindUpdateCart()},ProductInstance.prototype._initOptionSelectors=function(){var t=this,e=_.isObject(t.optionSelector);return t._hasSelector=t.$product.find("["+t.selectors.nativeSelect+"]").length,!!t._hasSelector&&(e?t.optionSelector._init():t.optionSelector=new(require("./optionSelector"))(t),void(t.product.settings.initOption&&t.variants._update()))},ProductInstance.prototype._initQuantity=function(){var t=this,e=t.$product.find("["+t.selectors.quantity+"]");e.each(function(e){t.quantity[e]=new(require("./quantity"))(t,this)})},ProductInstance.prototype.getInstance=function(t){var e,n=this;return e=_.isObject(t[0].Product)?t[0]:t.parents("["+n.selectors.product+"]:first")[0],e=!!e&&e.Product},ProductInstance.prototype._updateStatus=function(t){var e,n,i,r,a=this;if(r=a.quantity[0],void 0===r)return console.warn("Product: Quantity",'Не указан блок "Количество товаров" для ',a.$product),!1;if("update_variant"==t.event)return r.setVariant(a.variants.getVariant()),!1;a._hasSelector?(e=a.variants.getVariant(),n=r.get(),r=r.$input):(e=t.instance.variant,n=t.instance.get(),r=t.instance.$input),i=Cart.order.getItemByID(e.id),i&&a.settings&&"item"!=a.type&&(n+=i.quantity);var o=a.price_kinds.getPrice({variantId:e.id,quantity:n.current});e.action={method:t.method,product:a.$product,price:o,quantity:n,quantityInput:r},EventBus.publish("before:insales:"+a.type,e),"update_variant"!=t.event&&EventBus.publish(t.event+":insales:"+a.type,e),EventBus.publish("update_variant:insales:"+a.type,e),EventBus.publish("always:insales:"+a.type,e)},ProductInstance.prototype._bindUpdateCart=function(){var t=this;EventBus.subscribe("update_items:insales:cart",function(e){"init"!=e.action.method&&_.forEach(t.quantity,function(t){_.debounce(t._update,200)})})},module.exports=ProductInstance;
...
var $=require("jquery"),_=require("lodash"),EventBus=require("../events/events"),ProductQuantity=function(t,n){var e=this;e._owner=t,e.settings=e._owner.settings,e.selectors=e._owner.selectors,e.variant={},e.quantity={current:0,toCheck:0,max:1e7,min:0},e.unit="pce",e.decimal=0,e.node=n,e.$node=$(n),e.$input=e.$node.find("input[name]"),n.Quantity=e,e._init()};ProductQuantity.prototype._init=function(){var t,n=this;t=n._getConfig(),n.quantity={current:n._getQuantity(),toCheck:n._getQuantity()},n.unit=n._owner.product.unit,n.decimal=_.toInteger(n.settings.decimal[n.unit])||0,t.variantId?n.variant=n._owner.variants.getVariantById(t.variantId):n.variant=n._owner.variants.getVariant(),n.variant.quantity&&n.settings.useMax&&(n.quantity.max=n._fixValue(n.variant.quantity)),n.step=n._fixValue(t.step||Math.pow(10,-1*n.decimal)),n.quantity.min=n._fixValue(t.min||n.step),n._check(),n._bindEvents()},ProductQuantity.prototype._getConfig=function(){var t=this,n=t.$node.data()||{},e=_.words(t.$input.attr("name"));return"variant"!=e[0]&&"cart"!=e[0]||(n.variantId=_.toInteger(e[2])),n},ProductQuantity.prototype._getQuantity=function(){var t=this,n=t.$input.val();return n=n?n.replace(",",".").replace(/[^0-9.]/g,""):1,t._fixValue(n)},ProductQuantity.prototype.setVariant=function(t){var n=this;n.variant=t,n._check()},ProductQuantity.prototype.get=function(){var t=this,n=_.clone(t.quantity);return _.unset(n,"toCheck"),t.settings.useMax||_.unset(n,"max"),n},ProductQuantity.prototype._changeQuantity=function(t){var n=this;n.quantity.toCheck+=n._fixValue(t),n._check()},ProductQuantity.prototype._setQuantity=function(){var t=this;t.quantity.toCheck=t._getQuantity(),t._check()},ProductQuantity.prototype._check=function(){var t=this;_.clone(t.quantity);t.settings.max&&t.quantity.toCheck>t.quantity.max&&(t.quantity.toCheck=t.quantity.max),(isNaN(t.quantity.toCheck)||t.quantity.toCheck<t.quantity.min)&&(t.quantity.toCheck=t.quantity.min),t.quantityChanged=!1,t.quantity.current!==t.quantity.toCheck&&(t.quantity.current=t._fixValue(t.quantity.toCheck),t.quantityChanged=!0),t._update()},ProductQuantity.prototype._update=function(){var t=this;t.$input.val(t.quantity.current.toFixed(t.decimal)),setTimeout(function(){var n=t.quantityChanged?"change_quantity":"unchange_quantity";t._owner._updateStatus({event:n,method:"update",instance:t})},0)},ProductQuantity.prototype._getInstance=function(t){var n=this,e=t.parents("["+n.selectors.quantity+"]")[0];return void 0===e?(console.warn("Product: Quantity",'Не указан блок "Количество товаров" для',t),!1):e=e.Quantity},ProductQuantity.prototype._bindEvents=function(){var t=this;return!document.ProductQuantity&&(t._bindQuantityButtons(),t._bindQuantityInput(),void(document.ProductQuantity=!0))},ProductQuantity.prototype._bindQuantityButtons=function(){var t=this;$(document).on("click","["+t.selectors.quantityButton+"]",function(n){n.preventDefault();var e=$(this),a=t._getInstance(e);a._changeQuantity(e.data("quantity-change"))})},ProductQuantity.prototype._bindQuantityInput=function(){function t(t){t.preventDefault(),n._getInstance($(this))._setQuantity()}var n=this;$(document).on("blur change","["+n.selectors.quantity+"] input[name]",_.debounce(t,150)).on("keypress","["+n.selectors.quantity+"] input[name]",function(t){13==t.keyCode&&(t.preventDefault(),t.stopPropagation(),n._getInstance($(this))._setQuantity())})},ProductQuantity.prototype._fixValue=function(t){var n=this;return _.chain(t).toFinite().round(n.decimal).value()},module.exports=ProductQuantity;

},{"../events/events":10,"jquery":1,"lodash":2}],39:[function(require,module,exports){
var _=require("lodash"),ProductSettings=function(t,o){var e=this;e._default={options:{"default":"option-default"},showVariants:!0,initOption:!0,fileUrl:{},filtered:!0,useMax:!1,decimal:{kgm:1,dmt:1},withCart:!1},e._owner=o,e._set(t)};ProductSettings.prototype._set=function(t){var o=this;_.merge(o,o._default,t),o._patch()},ProductSettings.prototype._patch=function(){var t=this;_.forEach(t.options,function(o,e){Template.has(o)||(t.options[e]="option-default")})},ProductSettings.prototype.set=function(t){var o=this;o._set(t),o._owner._init()},module.exports=ProductSettings;

},{"lodash":2}],40:[function(require,module,exports){
var _=require("lodash"),URL=require("../tools/url"),_Translit=require("../tools/translit"),Translit=new _Translit,ProductVariants=function(t){var i=this;i._owner=t,i._variants={},i.variants=i._owner.product.variants,i.urlVariant=URL.getKeyValue("variant_id"),i._init()};ProductVariants.prototype._init=function(){var t=this;t.options=t._initOptions(),t.tree=t._initTree(),t.options=t._selectedOptions(t.options)},ProductVariants.prototype.setOwner=function(t){var i=this;i._owner=t},ProductVariants.prototype._initTree=function(){var t=this,i=t._owner.product.variants,n={};return _.forEach(i,function(i){var e=n;t._variants[i.id]=i,i.option_values.length?t._parseVariantOptions(i,e):t._addLeaf({id:0,title:"_empty",position:0},e,{id:i.id,available:i.available})}),_.forEach(n,function(i){t._nodeAvailable(i)}),n},ProductVariants.prototype._parseVariantOptions=function(t,i){var n=this;_.forEach(t.option_values,function(e,o){n._addValues(e,o);var r={id:void 0,available:void 0},a=o==t.option_values.length-1;a&&(r={id:t.id,available:t.available}),n._addLeaf(e,i,r),i=i[e.position].tree})},ProductVariants.prototype._addLeaf=function(t,i,n){i[_.toInteger(t.position)]||(i[_.toInteger(t.position)]={id:_.toInteger(t.id),tree:{},title:t.title,name:t.title.toLowerCase(),variant_id:n.id,position:_.toInteger(t.position)}),void 0!==n.available&&(i[_.toInteger(t.position)].available=n.available)},ProductVariants.prototype._nodeAvailable=function(t){var i=this;if(void 0===t.variant_id){var n=!1;_.forEach(t.tree,function(t){i._nodeAvailable(t)&&(n=!0)}),t.available=n}return t.available},ProductVariants.prototype._update=function(){var t=this;t._owner._updateStatus({event:"update_variant",method:"change"}),t.urlVariant&&(t._setOptionByVariant(t.urlVariant),t.urlVariant=!1)},ProductVariants.prototype.getLevel=function(t){var i=this,n=i.tree;return _.forEach(i.options,function(i,e){return t!=e&&void(n=n[i.selected].tree)}),n},ProductVariants.prototype.getFirst=function(t){var i=_.chain(t).toArray().first().value();return i},ProductVariants.prototype.getVariant=function(){var t,i=this,n=_.get(i,i._getSelectedVector()),e=n.variant_id;return i.urlVariant&&(e=i.urlVariant),t=_.findKey(i.variants,function(t){return t.id==e}),t||(t=_.findKey(i.variants,function(t){return t.id==n.variant_id})),i.variants[t]},ProductVariants.prototype.getVariantById=function(t){var i=this;return i._variants[t]},ProductVariants.prototype.setVariant=function(t){var i=this,n=i._owner.settings;n.initOption||(n.initOption=!0),i._setOptionByVariant(t),i._update()},ProductVariants.prototype._initOptions=function(){var t=this,i=t._owner.product.option_names,n=t._owner.settings.options;return i.length?_.forEach(i,function(t,i){t.handle=Translit.replace(t.title),t.renderType=n[t.title]||n["default"],t.values={}}):i[0]={handle:"_empty",title:"_empty",values:{},renderType:n["default"],position:0,id:0},i},ProductVariants.prototype._addValues=function(t,i){var n=this,e=n.options[i].values;e[t.position]||(e[t.position]=t,e[t.position].name=e[t.position].title.toLowerCase())},ProductVariants.prototype._selectedOptions=function(t){var i=this,n=i.tree;return _.forEach(t,function(e,o){var r=i.getFirst(n);t[o].selected=r.position,n=r.tree}),t},ProductVariants.prototype.setOption=function(t){var i=this,n=_.findKey(i.options,function(i){return i.id==t.option_name_id});i.options[n].selected==t.position&&i._owner.settings.initOption||(i.options[n].selected=t.position,_.forEach(i.options,function(t,n){var e=_.get(i,i._getSelectedVector(n+1));if(void 0===e){var o=i.getLevel(n),r=i.getFirst(o);t.selected=r.position}}),i._owner.settings.initOption||(i._owner.settings.initOption=!0),i._update())},ProductVariants.prototype.getOption=function(t){var i=this;return i.options[t]},ProductVariants.prototype.getFilterOption=function(t){var i=this,n=_.cloneDeep(i.getOption(t)),e=i.getLevel(t);return _.forEach(n.values,function(t,o){e[t.position]||(i._owner.settings.filtered?t.disabled=!0:delete n.values[o])}),n},ProductVariants.prototype._setOptionByVariant=function(t){var i=this,n=_.findKey(i.variants,function(i){return i.id==t});i.variants[n]&&_.forEach(i.variants[n].option_values,function(t,n){i.options[n].selected=t.position})},ProductVariants.prototype._getSelectedVector=function(t){var i=this,n="";return t=(t||i.options.length)-1,_.forEach(i.options,function(i,e){if(n+=".tree["+i.selected+"]",t==e)return!1}),n},module.exports=ProductVariants;

},{"../tools/translit":53,"../tools/url":54,"lodash":2}],41:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),_Storage=require("./storage"),_Product=require("../product/product"),_Singleton=require("../tools/singleton"),Products=function(){var t=this;t._settings={},t._products={},t._storage=new _Storage(t),t._init()};Products.prototype._init=function(){var t=this;t._getDomId().done(function(r){t._getList(r)})},Products.prototype.get=function(t){var r=this;return t=_.toInteger(t),r._getOne(t)},Products.prototype.getList=function(t){var r=this;return t=_.toArray(t),r._getList(t)},Products.prototype.setConfig=function(t){var r=this;r._settings=t,_.forEach(r._products,function(t){t.settings.set(r._settings)})},Products.prototype._getDomId=function(){var t=$.Deferred(),r=[];return $(function(){$("[data-product-id]").each(function(t,e){var o=_.toInteger($(e).data("product-id"));r.push(o)}),t.resolve(_.uniq(r))}),t.promise()},Products.prototype._getList=function(t){var r=this,e=$.Deferred(),o=_.difference(t,r._actualId);return o.length?r._storage.getProducts(o).done(function(o){_.forEach(o,function(t){r._initProduct(t)}),e.resolve(_.pick(r._products,t))}):e.resolve(_.pick(r._products,t)),e.promise()},Products.prototype._getOne=function(t){var r=this,e=$.Deferred();return r._getList([t]).done(function(t){t=_.toArray(t),e.resolve(t[0])}),e.promise()},Products.prototype._initProduct=function(t){var r=this;r._products[t.id]=new _Product(t,r._settings)},module.exports=_Singleton(Products).getInstance();

},{"../product/product":36,"../tools/singleton":52,"./storage":42,"jquery":1,"lodash":2}],42:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),ajax=require("../json/ajax.product"),URL=require("../tools/url"),EventBus=require("../events/events"),ProductsStorage=function(t){var e=this;e._settings={maxProducts:100,json:"products",liveTime:18e4},e._owner=t,e._storage=localStorage,e._json={},e._init()};ProductsStorage.prototype._init=function(){var t=this;t._json=t._loadJSON(),t._checkAlive()},ProductsStorage.prototype.getProducts=function(t){var e=this,o=$.Deferred(),r=_.differenceBy(t,_.keys(e._json),_.toInteger);return r.length?ajax.getList(r).done(function(r){e._updateJSON(r),o.resolve(_.pick(e._json,t))}):o.resolve(_.pick(e._json,t)),o.promise()},ProductsStorage.prototype._loadJSON=function(){var t=this,e=t._storage.getItem(t._settings.json),o=t._storage.getItem("lang"),r=URL.getKeyValue("lang")||"";return e=JSON.parse(e)||{},o=JSON.parse(o),o!==r&&(e={},t._storage.setItem("lang",JSON.stringify(r))),e},ProductsStorage.prototype._saveJSON=function(){var t=this,e=JSON.stringify(t._json);t._storage.setItem(t._settings.json,e)},ProductsStorage.prototype._updateJSON=function(t){var e=this;_.forEach(t,function(t){t.updatedAt=_.now(),e._json[t.id]=t}),e._saveJSON()},ProductsStorage.prototype._checkAlive=function(){var t=this,e=_.now();_.forEach(t._json,function(o,r){var s=e-o.updatedAt<t._settings.liveTime;s||_.unset(t._json,r)})},module.exports=ProductsStorage;

},{"../events/events":10,"../json/ajax.product":19,"../tools/url":54,"jquery":1,"lodash":2}],43:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),EventBus=require("../events/events"),_regTools=new(require("../tools/regTools")),_Singleton=require("../tools/singleton"),Search=function(){var e=this;e._default={settings:{searchSelector:"data-search-field",resultPlaceholder:"data-search-result",markerClass:"ajax_search-marked",letters:3,template:"search-default",delay:300}},e.path="/search_suggestions",e.keyupTimeoutID="",e._init()};Search.prototype._init=function(){var e=this;e.setConfig({}),e._ui=new(require("./search.ui"))(e)},Search.prototype._get=function(e){var t=this;EventBus.publish("before:insales:search"),clearTimeout(t.keyupTimeoutID),t._isValid(e.query)?(t.data.query=e.query,t.keyupTimeoutID=setTimeout(function(){$.getJSON(t.path,t.data,function(s){t._update(_.merge(e,s))})},t.settings.delay)):t._update(e)},Search.prototype._update=function(e){var t=this,s={suggestions:t._patch(e),action:e};s.invalid=!t._isValid(e.query),s.empty=!_.size(e.suggestions),s.letters=t.settings.letters,_.unset(s.action,"suggestions"),EventBus.publish("update:insales:search",s)},Search.prototype.setConfig=function(e){var t=this;_.merge(t,t._default,{settings:e}),t.settings.replacment='<span class="'+t.settings.markerClass+'">$1</span>'},Search.prototype._setData=function(e){var t=this;_.merge(t,{data:e})},Search.prototype._patch=function(e){var t=this,s=new RegExp("("+_regTools.escape(e.query)+")","gi");return _.reduce(e.suggestions,function(e,r){var a={id:r.data,url:"/product_by_id/"+r.data,title:r.value,markedTitle:r.value.replace(s,t.settings.replacment)};return e.push(_.merge(r,a)),e},[])},Search.prototype._isValid=function(e){var t=this;return""!==e&&e.length>=t.settings.letters},module.exports=_Singleton(Search).getInstance();

},{"../events/events":10,"../tools/regTools":51,"../tools/singleton":52,"./search.ui":44,"jquery":1,"lodash":2}],44:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),EventBus=require("../events/events"),SearchDOM=function(e){var t=this;t._owner=e,t.settings=t._owner.settings,t.settings.inProcess="inProcess",t._init()};SearchDOM.prototype._init=function(){var e=this;e._setConfig(),e._keyUp(),e._events(),e._outFocus()},SearchDOM.prototype._setConfig=function(){var e=this;$(function(){e._owner._setData({account_id:Site.account.id,locale:Site.language.locale,fields:["price_min","price_min_available"],hide_items_out_of_stock:Site.account.hide_items}),e.$searchField=$("["+e.settings.searchSelector+"]"),e.$searchForm=e.$searchField.parents("form:first"),e.$searchField.attr(e.settings.inProcess,!1)})},SearchDOM.prototype._getInstance=function(e){var t,r=e.data("target");return t=r?$(r):e.parents("form:first")},SearchDOM.prototype._keyUp=function(){var e=this;$(document).on("keyup","["+e.settings.searchSelector+"]",function(){var t=$(this),r=e._getInstance(t),n=t.val(),s=t.prop(e.settings.inProcess);document._searchActive=!0,s||t[0]._queryLength!=n.length&&(t[0]._queryLength=n.length,t.prop(e.settings.inProcess,!0),e._owner._get({query:n,input:t,form:r}))})},SearchDOM.prototype._events=function(){var e=this;EventBus.subscribe("update:insales:search",function(t){var r;r=t.action.form?t.action.form.find("["+e.settings.resultPlaceholder+"]"):$("["+e.settings.resultPlaceholder+"]"),r.html(Template.render(t,e.settings.template)),document._searchActive=!1,t.action.input&&t.action.input.prop(e.settings.inProcess,!1).trigger("keyup")})},SearchDOM.prototype._outFocus=function(){var e=this;$(document).on("click",function(t){var r=$("["+e.settings.searchSelector+"]"),n=r.parents("form:first");document._searchActive&&!$(t.target).closest(n).length&&e._owner._get({query:""})})},module.exports=SearchDOM;

},{"../events/events":10,"jquery":1,"lodash":2}],45:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),ajaxShop=require("../json/ajax.shop"),Client=function(e){var t=this;t._owner=e,t._init()};Client.prototype._init=function(){var e=this;e._get()},Client.prototype._get=function(){var e=this,t=$.Deferred();return ajaxShop.client().done(function(i){_.merge(e,i),t.resolve(e)}).fail(function(e){console.log("Client: _get: fail: ",e),t.reject(e)}),t.promise()},Client.prototype.get=function(){var e=this;return e._get()},module.exports=Client;

},{"../json/ajax.shop":20,"jquery":1,"lodash":2}],46:[function(require,module,exports){
var _=require("lodash"),Money=function(){var o=this;o._init()};Money.prototype._init=function(){},Money.prototype._set=function(o){var t=this;t.options=JSON.parse(o)},Money.prototype.set=function(o){var t=this;t._set(o)},Money.prototype.format=function(o){var t=this,e=o,n=/(\d)(?=(\d\d\d)+(?!\d))/g;return null===o||void 0===o?"":(e=e.toString().replace(",","."),e=parseFloat(e).toFixed(2)||0,e=e.toString().split("."),e[0]=e[0].replace(n,"$1"+t.options.delimiter),e=t.options.show_price_without_cents?e[0]:e.join(t.options.separator),e=t.options.format.replace("%n",e).replace("%u",t.options.unit))},module.exports=Money;

},{"lodash":2}],47:[function(require,module,exports){
var ajaxShop=require("../json/ajax.shop"),_Singleton=require("../tools/singleton"),Shop=function(){var e=this;e.money=new(require("./money")),e.client=new(require("./client"))(e),e._init()};Shop.prototype._init=function(){},Shop.prototype.sendMessage=function(e){return ajaxShop.message(e)},module.exports=_Singleton(Shop).getInstance();

},{"../json/ajax.shop":20,"../tools/singleton":52,"./client":45,"./money":46}],48:[function(require,module,exports){
var $=require("jquery"),_=require("lodash"),_default=require("./templateDefault"),_Singleton=require("../tools/singleton"),Template=function(){var t=this;t._templateList={},t._init()};Template.prototype.render=function(t,e){var a,l=this,o=l._templateList[e];return void 0!==o?a=l._templateList[e](t):(a=!1,console.warn("Template: ",e," не подключен")),a},Template.prototype.load=function(t,e){var a=this;a._templateList[e]=_.template(t)},Template.prototype._init=function(){var t=this;t.lock=!0,t.empty=!0,t._setDefault(),$(function(){var e=$("[data-template-id]");e.length?e.each(function(e,a){t.load($(a).html(),$(a).data("templateId")),$(a).is(":last")&&(t.lock=!1,t.empty=!1)}):(t.lock=!1,t.empty=!0)})},Template.prototype.has=function(t){var e=this,a=!1;return Template.empty&&!e._templateList[t]||(a=!0),a},Template.prototype._setDefault=_default,module.exports=_Singleton(Template).getInstance();

},{"../tools/singleton":52,"./templateDefault":49,"jquery":1,"lodash":2}],49:[function(require,module,exports){
var defaultTemplates=function(){var n=this,t='<div class="option-<%= option.handle %>">\n<label><%= option.title %></label>\n<select data-option-bind="<%= option.id %>">\n<% _.forEach(option.values, function (value){ %>\n<option\ndata-value-position="<%= value.position %>"\nvalue="<%= value.position %>"\n<% if (option.selected == value.position & initOption) { %>selected<% } %>\n>\n<%= value.title %>\n</option>\n<% }) %>\n</select>\n</div>',e='<% if (suggestions.length > 0){ %>\n<ul class="ajax_search-results">\n<% _.forEach(suggestions, function (product){ %>\n<li class="ajax_search-item">\n<a href="<%- product.url %>" class="ajax_search-link"><%= product.markedTitle %></a>\n</li><% }) %>\n</ul>\n<% } %>';n.load(t,"option-default"),n.load(e,"search-default")};module.exports=defaultTemplates;

},{}],50:[function(require,module,exports){
var Error=function(r,e){var a=this,n=new Error(e);return n.name=r||"Ошибка",a.name=n.name,a.message=n.message,n.stack&&(a.stack=n.stack),a.toString=function(){return a.name+": "+a.message},a};module.exports=Error;

},{}],51:[function(require,module,exports){
var _=require("lodash"),RegTools=function(){var o=this;o._toEscape=/[|\\{}()[\]^$+*?.]/g};RegTools.prototype.escape=function(o){var e=this;return _.isString(o)?o.replace(e._toEscape,"\\$&"):(console.warn("not string: ",o),!1)},module.exports=RegTools;

},{"lodash":2}],52:[function(require,module,exports){
module.exports=function(n){var e;return{getInstance:function(){return e||(e=new n),e}}};

},{}],53:[function(require,module,exports){
var _=require("lodash"),Translit=function(r){var t=this,e="_";t.translit={"а":"a","б":"b","в":"v","г":"g","д":"d","е":"e","ё":"e","ж":"zh","з":"z","и":"i","й":"j","к":"k","л":"l","м":"m","н":"n","о":"o","п":"p","р":"r","с":"s","т":"t","у":"u","ф":"f","х":"h","ц":"c","ч":"ch","ш":"sh","щ":"sh","ъ":e,"ы":"y","ь":e,"э":"e","ю":"yu","я":"ya"," ":e,_:e,"`":e,"~":e,"!":e,"@":e,"#":e,$:e,"%":e,"^":e,"&":e,"*":e,"(":e,")":e,"-":e,"=":e,"+":e,"[":e,"]":e,"\\":e,"|":e,"/":e,".":e,",":e,"{":e,"}":e,"'":e,'"':e,";":e,":":e,"?":e,"<":e,">":e,"№":e}};Translit.prototype.replace=function(r){var t=this;return _.reduce(r.toLowerCase(),function(r,e){return r+=void 0!==t.translit[e]?t.translit[e]:e},"")},module.exports=Translit;

},{"lodash":2}],54:[function(require,module,exports){
var _=require("lodash"),_Singleton=require("../tools/singleton"),URL=function(){var t=this;t._init()};URL.prototype._init=function(){var t=this;t.keys={},t.location=window.location,_.chain(t.location.search.replace("?","")).split("&").forEach(function(e){""!==e&&(e=e.split("="),t.keys[e[0]]=e[1])}).value()},URL.prototype.getKeyValue=function(t){var e=this;return e.keys[t]},module.exports=_Singleton(URL).getInstance();

},{"../tools/singleton":52,"lodash":2}]},{},[33])


//# sourceMappingURL=new_common.min.js.map
